...
<ul>
    ...
    <li><code>denk(zahl)</code>: Setzt die Zeit in Millisekunden, die zwischen zwei Aktionen des Roboters vergeht.</li>
    ...
    <li><code>sag(zeichenkette)</code>: Ein Dialog-Fenster erschein, in dem Reeborg eine Nachricht, nämlich die vorgegebene Zeichenkette, "sagt".</li>
</ul>
''' % ("basic-commands-" + __id)
